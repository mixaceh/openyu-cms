...
<body>
	...
	<div id="centercontent">
		...
		<div id="breadcrumb">
			...
			<@s.url var="currentUrl" namespace="/back/service/group" action="list">
			</@s.url>
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="18%"><@s.text name="group.names" /></th>
							<th width="13%"><@s.text name="group.dayUpload" /></th>
							<th width="13%"><@s.text name="group.maxUpload" /></th>
					...
					<tbody>
						<@s.iterator value="groups" var="group" status="st">
							<tr>
								...
								<td class="textright"><@s.property value="%{toString(dayUpload)}" /></td>
								<td class="textright"><@s.property value="%{toString(maxUpload)}" /></td>
								...
								<td><@s.property
										value="%{getTrueFalseName(captcha)}" /></td>
								<td><@s.property
										value="%{getTrueFalseName(check)}" /></td>
							</tr>
						</@s.iterator>
					</tbody>
				</table>
