...
<body>
	...
	<div id="centercontent">
		...
		<div id="breadcrumb">
			...
			<@s.url var="currentUrl" namespace="/back/service/adSpace" action="list">
			</@s.url>
			...
			<@s.form id="searchForm" name="searchForm">
				<table class="search" width="100%" border="0">
					<tbody>
						<tr>
							<#-- id -->
							<td width="5%" class="searchlabel"><@s.text name="adSpace.id" />
								:</td>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/adSpace" action="find" /> <@s.a
						...
						<tr>
							<#-- valid -->
							<td class="searchlabel"><@s.text name="adSpace.valid" /> :</td>
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/adSpace" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- add -->
				<li><@s.url var="url" namespace="/back/service/adSpace"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="6%"><@s.text name="adSpace.seq" /></th>
							<th width="12%"><@s.text name="global.operation" /></th>
							<th width="10%"><@s.text name="adSpace.id" /></th>
							<th width="25%"><@s.text name="adSpace.names" /></th>
							<th width="34%"><@s.text name="adSpace.descriptions" /></th>
							<th width="5%"><@s.text name="adSpace.valid" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="adSpaces" var="adSpace" status="st">
							<tr>
								...
								<#-- edit -->
								<td><@s.url var="url" namespace="/back/service/adSpace"
										action="edit">
								...
								<#-- edit -->
								<td><@s.checkbox name="%{'adSpaces['+#st.index+'].valid'}"
										fieldValue="true" /></td>
							</tr>
						</@s.iterator>
					</tbody>
