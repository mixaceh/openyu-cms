...
<body>
	...
	<div id="centercontent">
		...
		<div class="story">
			<@s.form id="addDirForm" name="addDirForm" namespace="/back/service/resource"
				action="addDirSave" validate="true">
					...
					<tbody>
						<tr>
							<td width="20%" class="freelabel"><span class="required">*</span>
								<@s.text name="resource.dirName" /> :</td>
							<td width="80%"><@s.textfield id="newName" name="newName"
