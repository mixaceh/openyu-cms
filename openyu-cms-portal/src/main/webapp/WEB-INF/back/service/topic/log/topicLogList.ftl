...
<body>
	...
	<div id="centercontent">
		<#-- breadcrumb -->
		<div id="breadcrumb">
			<@s.url var="parentUrl" namespace="/back/service/topic/log" action="index" />
			<@s.set name="parentTitle">
				<@s.text name="topic.log.title" />
			</@s.set>
			<@s.url var="currentUrl" namespace="/back/service/topic/log" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/topic/log" action="find" /> <@s.a href="#"
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/topic/log" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- delete -->
				<li><@s.url var="url" namespace="/back/service/topic/log"
		...
		<div class="story">
			<@s.form id="listForm" name="listForm">
				<table class="list" width="100%" border="0">
					...
					<tbody>
						<@s.iterator value="topicLogs" var="topicLog" status="st">
							<tr>
								<#-- pick -->
