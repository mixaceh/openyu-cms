...
<body>
	...
	<div id="centercontent">
		...
		<div id="breadcrumb">
			...
			<@s.url var="currentUrl" namespace="/back/service/sensitivity" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
				<table class="search" width="100%" border="0">
					<tbody>
						<tr>
							...
							<td width="63%">
								<#-- search --> 
								<@s.url var="url" namespace="/back/service/sensitivity" action="find" /> 
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/sensitivity"
						action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- add -->
				<li><@s.url var="url" namespace="/back/service/sensitivity"
						action="add">
				...
				<li><@s.url var="url" namespace="/back/service/sensitivity"
					...
					onclick="pickSubmit('listForm','keys','${url}',
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<#-- <th width="6%"><@s.text name="sensitivity.seq" /></th> -->
							<th width="12%"><@s.text name="global.operation" /></th>
							<th width="30%"><@s.text name="sensitivity.dictionarys.key" /></th>
							<th width="30%"><@s.text name="sensitivity.dictionarys.value" /></th>
							<th width="5%"><@s.text name="sensitivity.dictionarys.valid" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="sensitivity.dictionarys.values()" var="dictionary" status="st">
							<tr>
								<#-- pick -->
								...
								<#-- edit -->
								<td><@s.url var="url" namespace="/back/service/sensitivity"
										action="edit">
										<@s.param name="sensitivity.seq">
											<@s.property value="sensitivity.seq" />
										</@s.param>
