...
(function($) {
    ...
    $.fn.colorpicker = function(options) {
        ...
        return this.each(function(){
            ...
            obj.bind(opts.event,function(){
                //定位
                var ttop  = $(this).offset().top;     //控件的定位點高
                var thei  = $(this).height();  //控件本身的高
                var tleft = $(this).offset().left;    //控件的定位點寬
                $("#colorpanel").css({
                    top:ttop+thei+5,
                    left:tleft
                }).show();
        ...
        function initColor(){
            ...
            +'<td width="3"><td><input type="text" id="HexColor" size="7" style="border:inset 1px;font-family:Arial;" value="#000000"><a href="javascript:void(0);" id="_creset"><img src="/csm/jquery/colorpicker/clean.png"/></a></td><td><a href="javascript:void(0);" id="_cclose"><img src="/csm/jquery/colorpicker/close.png"/></a></td></tr></table></td></table>'
    ...
    jQuery.fn.colorpicker.defaults = {
        ishex : true, //是否使用16進制顏色值
        fillcolor:false,  //是否將顏色值填充至對象的val中
        target: null, //目標對像
        event: 'click', //顏色框顯示的事件
