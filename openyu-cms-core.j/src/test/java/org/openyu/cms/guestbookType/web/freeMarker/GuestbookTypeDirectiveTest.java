...
public class GuestbookTypeDirectiveTest extends GuestbookTypeTestSupporter
{
	@Test
	public void directive() throws Exception
	{
		...
		Template template = freeMarkerConfiguration
				.getTemplate("org/openyu/cms/guestbookType/web/freeMarker/cms_guestbook_type.ftl");
		//
		Map<String, Object> rootMap = new HashMap<String, Object>();
		rootMap.put("cms_guestbook_type", guestbookTypeDirective);
		//
