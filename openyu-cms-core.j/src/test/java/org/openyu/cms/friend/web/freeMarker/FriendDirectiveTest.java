...
public class FriendDirectiveTest extends FriendTestSupporter
{
	@Test
	public void directive() throws Exception
	{
		...
		Template template = freeMarkerConfiguration
				.getTemplate("org/openyu/cms/friend/web/freeMarker/cms_friend.ftl");
		//
		Map<String, Object> rootMap = new HashMap<String, Object>();
		rootMap.put("cms_friend", friendDirective);
		//
