package org.openyu.cms.template.vo;
...
public class TemplateCollectorTest extends AppBeanTestSupporter {
	...
	public void writeToXml() {
		String result = null;
		TemplateCollector collector = TemplateCollector.getInstance(false);
		//
		int count = 1;
		...
		for (int i = 0; i < count; i++) {
			...
			actionOption.addName(Locale.TRADITIONAL_CHINESE, "新建樣版");
			actionOption.addName(Locale.SIMPLIFIED_CHINESE, "新建范本");
			actionOption.addName(Locale.US, "Create Template");
			collector.getActionOptions().add(actionOption);
			//
			actionOption = new ActionOptionImpl();
			actionOption.setId(ActionType.SAVE_FILE);
			actionOption.addName(Locale.TRADITIONAL_CHINESE, "儲存樣版");
			actionOption.addName(Locale.SIMPLIFIED_CHINESE, "保存范本");
			actionOption.addName(Locale.US, "Save Template");
			collector.getActionOptions().add(actionOption);
			//
			actionOption = new ActionOptionImpl();
			actionOption.setId(ActionType.RENAME_FILE);
			actionOption.addName(Locale.TRADITIONAL_CHINESE, "更名樣版");
			actionOption.addName(Locale.SIMPLIFIED_CHINESE, "重命名范本");
			actionOption.addName(Locale.US, "Rename Template");
			collector.getActionOptions().add(actionOption);
			//
			actionOption = new ActionOptionImpl();
			...
			actionOption.addName(Locale.TRADITIONAL_CHINESE, "刪除樣版");
			actionOption.addName(Locale.SIMPLIFIED_CHINESE, "删除范本");
			actionOption.addName(Locale.US, "Delete Template");
			collector.getActionOptions().add(actionOption);
			//
			actionOption = new ActionOptionImpl();
			...
			actionOption.addName(Locale.TRADITIONAL_CHINESE, "上傳樣版");
			actionOption.addName(Locale.SIMPLIFIED_CHINESE, "上傳范本");
			actionOption.addName(Locale.US, "Upload Template");
			collector.getActionOptions().add(actionOption);
			...
			collector.getLogInquiry().getOrders().add(order);
			//
			result = collector.writeToXml(TemplateCollector.class, collector);
		}
		//
	...
	public void readFromXml() {
		TemplateCollector result = null;
		//
		int count = 1;
		long beg = System.currentTimeMillis();
		//
		for (int i = 0; i < count; i++) {
			result = beanCollector.readFromXml(TemplateCollector.class);
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");
	...
	public void writeToSerFromXml() {
		...
		long beg = System.currentTimeMillis();
		for (int i = 0; i < count; i++) {
			result = beanCollector.writeToSerFromXml(TemplateCollector.class);
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");
	...
	public void readFromSer() {
		...
		//
		for (int i = 0; i < count; i++) {
			result = beanCollector.readFromSer(TemplateCollector.class);
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");
	...
	public void initialize() {
		...
		//
		for (int i = 0; i < count; i++) {
			TemplateCollector.getInstance().initialize();
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");

		System.out.println(TemplateCollector.getInstance().isInitialized());
	}
	...
	public void reset() {
		...
		//
		for (int i = 0; i < count; i++) {
			TemplateCollector.getInstance().reset();
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");
	...
	public void getInstance() {
		// 初始化
		// ValidTemplateCollector.getInstance().initialize();
		// #fix
		...
		//
		for (int i = 0; i < count; i++) {
			result = TemplateCollector.getInstance();
		}
		//
		long end = System.currentTimeMillis();
		System.out.println(count + " times: " + (end - beg) + " mills. ");
	...
	public void getActionName() {
		TemplateCollector collector = TemplateCollector.getInstance();
		String result = null;
		//
		int count = 1000000; // 100w
		long beg = System.currentTimeMillis();
