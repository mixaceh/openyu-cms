 ...
 * @param siteId
 */
public class FriendTypeListDirective extends AppDirectiveSupporter
{
	@Autowired
	@Qualifier("friendTypeService")
	protected transient FriendTypeService friendTypeService;

	public FriendTypeListDirective()
	{}
		...
		throws TemplateException, IOException
	{
		...
		results = friendTypeService.findFriendType(getLocale(), siteSearcher, null);
