...
java -Xmn96m -Xms192m -Xmx192m -Xss256k -XX:PermSize=64m -cp %_CLASSPATH% -XX:+UseParNewGC -Djava.net.preferIPv4Stack=true -verbose:gc org.openyu.cms.core.App %1 %2 %3 %4 %5 %6 %7 %8 %9
