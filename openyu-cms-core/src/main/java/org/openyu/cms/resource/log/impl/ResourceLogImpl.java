package org.openyu.cms.resource.log.impl;
...
@Table(name = "cms_resource_log")
@SequenceGenerator(name = "cms_resource_log_g", sequenceName = "cms_resource_log_s", allocationSize = 1)
//when use ehcache, config in ehcache.xml
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE, region = "org.openyu.cms.resource.log.impl.ResourceLogImpl")
@Proxy(lazy = false)
@org.hibernate.annotations.Table(appliesTo = "cms_resource_log", indexes = { @org.hibernate.annotations.Index(name = "idx_cms_resource_log_1", columnNames = {
		"site_seq", "client_ip", "user_id", "log_date", "action_type" }) })
//--------------------------------------------------
//search
//--------------------------------------------------
//@Indexed
public class ResourceLogImpl extends AppLogEntitySupporter implements ResourceLog
{
	...
	public ResourceLogImpl()
	{}

	@Id
	@Column(name = "seq")
	@GeneratedValue(strategy = GenerationType.AUTO, generator = "cms_resource_log_g")
	public Long getSeq()
	{
		return seq;
	}
	...
	public Object clone()
	{
		ResourceLogImpl copy = null;
		copy = (ResourceLogImpl) super.clone();
