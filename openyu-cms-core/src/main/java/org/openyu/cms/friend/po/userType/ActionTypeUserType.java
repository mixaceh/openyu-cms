package org.openyu.cms.friend.po.userType;
...
public class ActionTypeUserType extends BaseUserTypeSupporter
{
	...
	private static final long serialVersionUID = 6282813263827329367L;
	...
	protected ActionType disassembleBy_1(StringBuilder src)
	{
		...
		if (src != null)
		{
			result = EnumHelper.valueOf(ActionType.class, toObject(src.toString(), int.class));
		}
		return result;
	}
}
