...
<body>
	...
	<div id="centercontent">
		<#-- breadcrumb -->
		<div id="breadcrumb">
			<@s.url var="parentUrl" namespace="/back/service/keyword/log" action="index" />
			<@s.set name="parentTitle">
				<@s.text name="keyword.log.title" />
			</@s.set>
			<@s.url var="currentUrl" namespace="/back/service/keyword/log" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/keyword/log" action="find" /> <@s.a href="#"
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/keyword/log" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- delete -->
				<li><@s.url var="url" namespace="/back/service/keyword/log"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="5%"><@s.text name="log.orig" />:<@s.text name="keyword.dictionarys.key" /></th>
							<th width="6%"><@s.text name="log.orig" />:<@s.text name="keyword.dictionarys.value" /></th>
							<th width="4%"><@s.text name="log.orig" />:<@s.text name="keyword.dictionarys.valid" /></th>
							<th width="5%"><@s.text name="log.new" />:<@s.text name="keyword.dictionarys.key" /></th>
							<th width="6%"><@s.text name="log.new" />:<@s.text name="keyword.dictionarys.value" /></th>
							<th width="4%"><@s.text name="log.new" />:<@s.text name="keyword.dictionarys.valid" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="keywordLogs" var="keywordLog" status="st">
							<tr>
								<#-- pick -->
