...
<body>
	...
	<div id="centercontent">
		<#-- breadcrumb -->
		<div id="breadcrumb">
			<@s.url var="parentUrl" namespace="/back/service/guestbook/log" action="index" />
			<@s.set name="parentTitle">
				<@s.text name="guestbook.log.title" />
			</@s.set>
			<@s.url var="currentUrl" namespace="/back/service/guestbook/log" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/guestbook/log" action="find" /> <@s.a href="#"
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/guestbook/log" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- delete -->
				<li><@s.url var="url" namespace="/back/service/guestbook/log"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="20%"><@s.text name="guestbook.titles" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="guestbookLogs" var="guestbookLog" status="st">
							<tr>
								<#-- pick -->
