...
<body>
	...
	<div id="centercontent">
		...
		<div id="breadcrumb">
			...
			<@s.url var="currentUrl" namespace="/back/service/guestbookType" action="list">
			</@s.url>
			...
			<@s.form id="searchForm" name="searchForm">
				<table class="search" width="100%" border="0">
					<tbody>
						<tr>
							<#-- id -->
							<td width="5%" class="searchlabel"><@s.text name="guestbookType.id" />
								:</td>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/guestbookType" action="find" /> <@s.a
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/guestbookType" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- add -->
				<li><@s.url var="url" namespace="/back/service/guestbookType"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="6%"><@s.text name="guestbookType.seq" /></th>
							<th width="12%"><@s.text name="global.operation" /></th>
							<th width="10%"><@s.text name="guestbookType.id" /></th>
							<th width="25%"><@s.text name="guestbookType.names" /></th>
							<th width="34%"><@s.text name="guestbookType.descriptions" /></th>
							<th width="34%"><@s.text name="guestbookType.sort" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="guestbookTypes" var="guestbookType" status="st">
							<tr>
								...
								<#-- edit -->
								<td><@s.url var="url" namespace="/back/service/guestbookType"
										action="edit">
								...
								<#-- edit -->
								<td><@s.textfield name="%{'guestbookTypes['+#st.index+'].sort'}"
