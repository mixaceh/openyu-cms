...
<body>
	...
	<div id="centercontent">
		...
		<div id="breadcrumb">
			...
			<@s.url var="currentUrl" namespace="/back/service/friendType" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/friendType" action="find" /> <@s.a
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/friendType" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- add -->
				<li><@s.url var="url" namespace="/back/service/friendType"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="6%"><@s.text name="friendType.seq" /></th>
							<th width="12%"><@s.text name="global.operation" /></th>
							<th width="10%"><@s.text name="friendType.id" /></th>
							<th width="40%"><@s.text name="friendType.names" /></th>
							<th width="13%"><@s.text name="friendType.sort" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="friendTypes" var="friendType" status="st">
							<tr>
								...
								<#-- edit -->
								<td><@s.url var="url" namespace="/back/service/friendType"
										action="edit">
								...
								<#-- edit -->
								<td><@s.textfield
										name="%{'friendTypes['+#st.index+'].sort'}" size="10"
										maxlength="10" cssClass="textright"/>
							</tr>
						</@s.iterator>
					</tbody>
				</table>
