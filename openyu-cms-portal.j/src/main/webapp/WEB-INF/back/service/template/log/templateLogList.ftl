...
<body>
	...
	<div id="centercontent">
		<#-- breadcrumb -->
		<div id="breadcrumb">
			<@s.url var="parentUrl" namespace="/back/service/template/log" action="index" />
			<@s.set name="parentTitle">
				<@s.text name="template.log.title" />
			</@s.set>
			<@s.url var="currentUrl" namespace="/back/service/template/log" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/template/log" action="find" /> <@s.a href="#"
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/template/log" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- delete -->
				<li><@s.url var="url" namespace="/back/service/template/log"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="13%"><@s.text name="log.logDate" /></th>
							<th width="5%"><@s.text name="log.userId" /></th>
							<th width="2%"><@s.text name="log.clientIp" /></th>
							<th width="6%"><@s.text name="log.action" /></th>
							<th width="12%"><@s.text name="template.log.beforePath" /></th>
							<th width="12%"><@s.text name="template.log.afterPath" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="templateLogs" var="templateLog" status="st">
							<tr>
								<#-- pick -->
								...
								<td><@s.property value="beforePath" /></td>
								<td><@s.property value="afterPath" /></td>
							</tr>
						</@s.iterator>
					</tbody>
				</table>
