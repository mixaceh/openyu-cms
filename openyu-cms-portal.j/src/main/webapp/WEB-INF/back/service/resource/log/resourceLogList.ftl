...
<body>
	...
	<div id="centercontent">
		<#-- breadcrumb -->
		<div id="breadcrumb">
			<@s.url var="parentUrl" namespace="/back/service/resource/log" action="index" />
			<@s.set name="parentTitle">
				<@s.text name="resource.log.title" />
			</@s.set>
			<@s.url var="currentUrl" namespace="/back/service/resource/log" action="list">
			</@s.url>
		...
		<div class="feature">
			...
			<@s.form id="searchForm" name="searchForm">
					...
					<tbody>
						<tr>
							...
							<td width="63%"><@s.url var="url"
									namespace="/back/service/resource/log" action="find" /> <@s.a href="#"
				...
				<div id="pagination">
					<@s.url var="url" namespace="/back/service/resource/log" action="find" />
		...
		<div id="opnav">
			<ul>
				<#-- delete -->
				<li><@s.url var="url" namespace="/back/service/resource/log"
				...
				<table class="list" width="100%" border="0">
					<thead>
						<tr>
							...
							<th width="12%"><@s.text name="resource.log.beforePath" /></th>
							<th width="12%"><@s.text name="resource.log.afterPath" /></th>
						</tr>
					</thead>
					<tbody>
						<@s.iterator value="resourceLogs" var="resourceLog" status="st">
							<tr>
								<#-- pick -->
